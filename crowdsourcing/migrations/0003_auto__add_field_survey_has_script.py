...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.has_script'
        db.add_column('crowdsourcing_survey', 'has_script',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.has_script'
        db.delete_column('crowdsourcing_survey', 'has_script')
