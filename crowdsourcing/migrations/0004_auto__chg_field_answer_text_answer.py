...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.text_answer'
        db.alter_column('crowdsourcing_answer', 'text_answer', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Answer.text_answer'
        db.alter_column('crowdsourcing_answer', 'text_answer', self.gf('django.db.models.fields.TextField')(default=''))
