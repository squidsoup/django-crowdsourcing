...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.date_answer'
        db.alter_column('crowdsourcing_answer', 'date_answer', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Answer.date_answer'
        db.alter_column('crowdsourcing_answer', 'date_answer', self.gf('django.db.models.fields.DateField')(default=2001))
